...
HD_PWD='E:/2022jcs/area_competition/encoder_top/encoder_top.runs/fifo_64_128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_64_128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_64_128.tcl
