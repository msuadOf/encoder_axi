...
HD_PWD='E:/2022jcs/area_competition/encoder_top/encoder_top.runs/fifo_128_128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_128_128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_128_128.tcl
